...
const StarBorder = <T extends React.ElementType = 'button'>({
  ...
  return (
    ...
    >
      ...
      ></div>
      <div className="relative z-1 bg-gradient-to-b from-white to-gray-100 border border-gray-300 text-gray-900 text-center text-[16px] py-[16px] px-[26px] rounded-[20px]">
        {children}
      </div>
    </Component>
  );
